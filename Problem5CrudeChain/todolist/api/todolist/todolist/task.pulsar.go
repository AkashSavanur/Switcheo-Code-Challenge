...
func init() {
	...
	md_Task = File_todolist_todolist_task_proto.Messages().ByName("Task")
...
func (x *Task) slowProtoReflect() protoreflect.Message {
	mi := &file_todolist_todolist_task_proto_msgTypes[0]
...
func (x *fastReflection_Task) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "todolist.todolist.Task.title":
		return x.Title != ""
	case "todolist.todolist.Task.description":
		return x.Description != ""
	case "todolist.todolist.Task.creator":
		return x.Creator != ""
	case "todolist.todolist.Task.id":
		return x.Id != uint64(0)
	case "todolist.todolist.Task.completed":
		return x.Completed != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: todolist.todolist.Task"))
		}
		panic(fmt.Errorf("message todolist.todolist.Task does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Task) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message todolist.todolist.Task does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Task) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "todolist.todolist.Task.title":
		panic(fmt.Errorf("field title of message todolist.todolist.Task is not mutable"))
	case "todolist.todolist.Task.description":
		panic(fmt.Errorf("field description of message todolist.todolist.Task is not mutable"))
	case "todolist.todolist.Task.creator":
		panic(fmt.Errorf("field creator of message todolist.todolist.Task is not mutable"))
	case "todolist.todolist.Task.id":
		panic(fmt.Errorf("field id of message todolist.todolist.Task is not mutable"))
	case "todolist.todolist.Task.completed":
		panic(fmt.Errorf("field completed of message todolist.todolist.Task is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: todolist.todolist.Task"))
		}
...
func (x *fastReflection_Task) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in todolist.todolist.Task", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: todolist/todolist/task.proto
...
func (*Task) Descriptor() ([]byte, []int) {
	return file_todolist_todolist_task_proto_rawDescGZIP(), []int{0}
}
...
var File_todolist_todolist_task_proto protoreflect.FileDescriptor

var file_todolist_todolist_task_proto_rawDesc = []byte{
	0x0a, 0x1c, 0x74, 0x6f, 0x64, 0x6f, 0x6c, 0x69, 0x73, 0x74, 0x2f, 0x74, 0x6f, 0x64, 0x6f, 0x6c,
	0x69, 0x73, 0x74, 0x2f, 0x74, 0x61, 0x73, 0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x11,
	0x74, 0x6f, 0x64, 0x6f, 0x6c, 0x69, 0x73, 0x74, 0x2e, 0x74, 0x6f, 0x64, 0x6f, 0x6c, 0x69, 0x73,
	0x74, 0x22, 0x86, 0x01, 0x0a, 0x04, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69,
	...
	,
}

var (
	file_todolist_todolist_task_proto_rawDescOnce sync.Once
	file_todolist_todolist_task_proto_rawDescData = file_todolist_todolist_task_proto_rawDesc
)

func file_todolist_todolist_task_proto_rawDescGZIP() []byte {
	file_todolist_todolist_task_proto_rawDescOnce.Do(func() {
		file_todolist_todolist_task_proto_rawDescData = protoimpl.X.CompressGZIP(file_todolist_todolist_task_proto_rawDescData)
	})
	return file_todolist_todolist_task_proto_rawDescData
}

var file_todolist_todolist_task_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_todolist_todolist_task_proto_goTypes = []interface{}{
	(*Task)(nil), // 0: todolist.todolist.Task
}
var file_todolist_todolist_task_proto_depIdxs = []int32{
...
func init() { file_todolist_todolist_task_proto_init() }
func file_todolist_todolist_task_proto_init() {
	if File_todolist_todolist_task_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_todolist_todolist_task_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Task); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_todolist_todolist_task_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_todolist_todolist_task_proto_goTypes,
		DependencyIndexes: file_todolist_todolist_task_proto_depIdxs,
		MessageInfos:      file_todolist_todolist_task_proto_msgTypes,
	}.Build()
	File_todolist_todolist_task_proto = out.File
	file_todolist_todolist_task_proto_rawDesc = nil
	file_todolist_todolist_task_proto_goTypes = nil
	file_todolist_todolist_task_proto_depIdxs = nil
}
